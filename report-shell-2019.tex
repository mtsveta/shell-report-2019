...
the conventional approach) is less that 1\% in mineral's \sveta{phase-volumes} and less that 16\% 
...
\begin{itemize} 
\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
\item Application of the smart chemical kinetics algorithm alone provides speedup of {\bf 8-10x}
%
...
%
\begin{enumerate} \setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
\item Improvement of the acceptance criterion in the ODML algorithm (providing less learnings 
...
%---------------------------------------------------------------------------------------------------%
%
\item Including smart chemical equilibrium algorithm into the RHS evaluation of the system of ODEs 
governing kinetically controlled species, which can cause up to hundreds of chemical equilibrium 
calculations.
%
