...
main future tasks and steps of futher investigation. 
...
transport problem, where chemistry is controlled by local equilibrium, and Pitzer activity model is 
considered as activity model for the aqueous species. After extensive tests of such chemical system 
with 36~species in 4~phases the following results has been obtained:
%
\begin{itemize} 
\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
\item Application of the ODML algorithm yields speedup of {\bf 200} (in the worst case) and {\bf 400} 
(in the best / zero-cost-search case) for chemical calculation in reactive transport.
%
\item Only {\bf 258} chemical states out of 1,000,000 has been evaluated fully (by triggering Gibbs 
energy minimization (GEM) problem), the rest 99.97 \% of the cells are estimated in a quick and 
accurate way.
%
\item The relative error in the approximations provided by the ODLM (in comparison to the conventional 
approach) is less that 1\% in mineral's phase volumes and less that 16\% in the aqueous species.  
%
\item ...
\end{itemize}
%
\item The ODML algorithm was extended the reactive transport problem including chemical kinetics. 
Extended tests on the one-dimensional benchmark example with one mineral assumed to be controlled 
kinetically has provided the following results:
%
\begin{itemize} 
\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
\item Application of the smart chemical kinetics algorithm alone provides speedup of {\rm 8-10x}
%
\item Application of the smart chemical kinetics algorithm together with smart equilibrium provides 
speedup of {\bf 30x} (in the worst case) and of {\bf 100x} (in the best case).
%
\end{itemize}
%
...
{\bf 92-124x} for 3 reactions.
%
\item Reaktoro has been coupled with open-source partial differential equations solver Firedrake 
for modeling high-dimensional heterogeneous reactive transport problems and further testing of 
the ODML algorithm on more challenging scenarios.   
\end{itemize}
%---------------------------------------------------------------------------------------------------%
...
\begin{itemize} 
\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
\item Improvement of the acceptance criterion (less learnings \& high accuracy)
%
\item Improvement of the time for the reference element retrieval:
\begin{itemize} 
\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
\item combination of tree-based and linear search algorithms
\item 
\end{itemize}
%
...
\begin{itemize} 
\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
\item more advanced chemical systems, such as reactive transport for the rich chemical system, 
where cement is attacked by seawater or NaCl brine, represented by 170 species with about a dozen 
of different phases (including complex multi-mineral phases)
...
developed during couple of last decades { \color{red} TODO: add citation to classic works \cite{HairerNorsettWanner1993, HairerWanner1996}}. 
...
\qquad \quad \, $b_j$, $j = 1, ..., {\rm J}$ \COMMENT{amounts of elemnts} \\[4pt]
% 
...
results from Subsection \eqref{subsec:part-1}, the most learnings are needed as the perturbation 
...
in the total numbers of the of the learnings needed for kinetics and equilibrium species. For the 
...
\includegraphics[width=0.5\textwidth]{figures/kinetics-only/computing-costs} \label{fig:computational-cost-kinetics-1}}
\subfloat[The ODML applied for both kinetics and equilibrium]{
\includegraphics[width=0.5\textwidth]{figures/kinetics/computing-costs}
...
to the curves in Figure \ref{fig:computational-cost-kinetics-2}. These spikes correspond to learnings happening 
...
\begin{figure}[!t]
\begin{centering}
\includegraphics[width=0.5\textwidth]{figures/kinetics/estimate-search-costs.pdf}
\par\end{centering}
...
\begin{centering}
\subfloat[The ODML applied for kinetics only]{
\includegraphics[width=0.5\textwidth]{figures/kinetics-only/speedups}
\label{fig:speedup-with-and-without-search-costs-kinetics-1}}
\subfloat[The ODML applied for both kinetics and equilibrium]{
\includegraphics[width=0.5\textwidth]{figures/kinetics/speedups}
...
\begin{figure}[!t]
\begin{centering}
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/minerals-0s.png}}\quad
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/minerals-2s.png}}\\[5pt]
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/minerals-5s.png}}\quad
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/minerals-7s.png}}
\par\end{centering}
...
\begin{figure}[!t]
\begin{centering}
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/ca-ion.png}}\quad
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/magnesium-ion.png}}\\[5pt]
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/hco3-ion.png}}\quad
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/co2-aq.png}}
\par\end{centering}
...
\begin{figure}[!t]
\begin{centering}
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/porosity-0s.png}}\quad
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/porosity-2s.png}}\\[5pt]
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/porosity-5s.png}}\quad
\subfloat[]{\includegraphics[width=0.45\textwidth]{figures/rok/porosity-7s.png}}
\par\end{centering}
