...
assuming $p_{\rm L} = 10100$~Pa and $p_{\rm R} = 10^5$~Pa. Then, the Neumann part will correspond 
to the top and the bottom with $\boldsymbol{v}|_{\rm T} \cdot \boldsymbol{n}_{\rm T}$ = 
$\boldsymbol{v}|_{\rm B} \cdot \boldsymbol{n}_{\rm B} = u_D = 0$, where $\boldsymbol{n}_{\rm T}$ and
$\boldsymbol{n}_{\rm T}$ are outward unit normal vectors on the top and bottom surface of the rock.
%---------------------------------------------------------------------------------------------------%
...
n(t_{0}) & = {\overline{n}}\qquad \quad t = t_{0}.
\end{cases}
\label{eq:reaction}
\end{equation}
%
...
\includegraphics[width=0.47\textwidth]{figures/kinetics-sa-50/on-demand-learning-countings}}
\subfloat[Accumulated amount of the on-demand leanings]{
\includegraphics[width=0.47\textwidth]{figures/kinetics-sa-50/on-demand-learning-total}}
...
\includegraphics[width=0.47\textwidth]{figures/kinetics-sa-50/computing-costs}
\label{fig:computational-cost-kinetics-sa-50}}
\subfloat[Speedups]{
\includegraphics[width=0.47\textwidth]{figures/kinetics-sa-50/speedups}
...
%---------------------------------------------------------------------------------------------------%
Illustrations of the results obtained for the numerical example, where both calcite and dolomite are
considered dissolving and precipitation kinetically. 
%
\begin{lstlisting}[language=Python, caption=Parameters of the rate model for Dolomite]
...
The initial composition of the rock contains not only calcite but also dolomite.
...
\label{fig:minerals-1000-kinetics-calcite-dolomite0}}
\subfloat[]{\includegraphics[width=0.46\textwidth, 
...
\caption{\emph{On-demand learning} operations triggered by the smart chemical kinetics 
(a) per each time step and (b) accumulated during the reactive transport. 
Overall, ** (or **\%) of 1'000'000 chemical states were evaluated using the full numerical 
integration of the system of ODEs for kinetically controlled species, the rest 99.79\% were quickly 
and accurately estimated ODML algorithm.
