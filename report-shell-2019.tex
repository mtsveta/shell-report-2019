...
\par\end{center}}
\begin{abstract}
Report in dedicated to describing the results and the progress of the first year 
of the project 'Reaktoro as the chemical reaction solver in Shell's reservoir simulator'....
